...
# --------------------------------------------#
# ASSIGNMENT:
# Follow the video of Unit 7 in order to go through
# the final project.
#
...
#
# OBJECTIVE:
# This assignment has for goal to incorporate everything we've seen
# in the class and use them in this final project.
#
